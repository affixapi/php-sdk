...
class TokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets client_secret
     *
     * @param string $client_secret The client secret. Since there can be multiple `client_secret`s (to allow for rotation of secrets without downtime to your customers), any current `client_secret` is valid  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out.
     *
     * @return self
     */
     ...
     * Sets grant_type
     *
     * @param string $grant_type This is a hardcoded value required by the OAuth 2.1 spec
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string $code This is the code you received in the query string
     *
     * @return self
     */
     ...
     * Sets redirect_uri
     *
     * @param string $redirect_uri Indicates the URI to return the user to after authorization is complete, which is the endpoint on your server to receive the authorization_code.  Must be identical to the redirect URI provided in the original link.  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out.
     *
     * @return self
     */
