...
/**
 * DisconnectResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DisconnectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisconnectResponse';
     ...
     * @return string[]
     */
    public function getDisconnectedAllowableValues()
    {
        return [
            self::DISCONNECTED_TRUE,
        ];
    }
    ...
    {
        $this->container['disconnected'] = $data['disconnected'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getDisconnectedAllowableValues();
        if (!is_null($this->container['disconnected']) && !in_array($this->container['disconnected'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'disconnected', must be one of '%s'",
                $this->container['disconnected'],
     ...
     * Sets disconnected
     *
     * @param bool $disconnected The access token has been disconnected and is no longer allowed to be used by your application
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getDisconnectedAllowableValues();
        if (!in_array($disconnected, $allowedValues, true)) {
