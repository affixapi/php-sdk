...
------------- | ------------- | ------------- | -------------
 **employment_status** | [**\OpenAPI\Client\Model\EmploymentStatusNotNullNotNullable**](../Model/.md)| Enable server-side filtering of the &#x60;employment_status&#x60; attribute. Will only include individuals with that attribute explicitly set (ie if an individuals has a &#x60;null&#x60;, it will not be returned if this parameter is set) | [optional]
