...
class IntrospectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntrospectResponse';
    ...
    protected static $openAPITypes = [
        ...
        'scopes' => '\OpenAPI\Client\Model\ScopesResponse[]'
    ];
     ...
     * Gets mode
     *
     * @return \OpenAPI\Client\Model\ModeResponse
     */
     ...
     * Sets mode
     *
     * @param \OpenAPI\Client\Model\ModeResponse $mode mode
     *
     * @return self
     */
     ...
     * Gets provider
     *
     * @return \OpenAPI\Client\Model\ProviderResponse
     */
     ...
     * Sets provider
     *
     * @param \OpenAPI\Client\Model\ProviderResponse $provider provider
     *
     * @return self
     */
     ...
     * Gets scopes
     *
     * @return \OpenAPI\Client\Model\ScopesResponse[]
     */
     ...
     * Sets scopes
     *
     * @param \OpenAPI\Client\Model\ScopesResponse[] $scopes One or more scope values indicating which parts of the user's account you wish to access.  Note, slight deviation from the OAuth 2.1 spec in that the param is scopes (plural) is used vs scope (singular)
     *
     * @return self
     */
