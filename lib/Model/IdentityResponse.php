 ...
 */
class IdentityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdentityResponse';
     ...
     * Sets name
     *
     * @param string $name The name of the individual for the respective account, if known
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string $email The email of the individual for the respective account, if known
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string $phone_number The phone number of the individual for the respective account, if known. Nullable for tokens created prior to 2023-03-05
     *
     * @return self
     */
