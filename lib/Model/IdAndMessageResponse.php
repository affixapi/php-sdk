...
/**
 * IdAndMessageResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IdAndMessageResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdAndMessageResponse';
     ...
     * Sets id
     *
     * @param string $id The id of the entity that the id applies. For example, the transaction id
     *
     * @return self
     */
