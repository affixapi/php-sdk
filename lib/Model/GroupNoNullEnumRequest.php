...
/**
 * GroupNoNullEnumRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GroupNoNullEnumRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'group-no-null-enumRequest';
    ...
    const TYPE_COST_CENTRE = 'cost_centre';
    const TYPE_PAY_GROUP = 'pay_group';
