...
class CoreApi
{
     ...
     * @return object[]|\OpenAPI\Client\Model\MessageResponse
     */
    public function providers()
    {
        list($response) = $this->providersWithHttpInfo();
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object[]|\OpenAPI\Client\Model\MessageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function providersWithHttpInfo()
    {
        $request = $this->providersRequest();
     ...
     */
    public function providersAsync()
    {
        return $this->providersAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function providersAsyncWithHttpInfo()
    {
        $returnType = 'object[]';
        $request = $this->providersRequest();
