...
/**
 * PayslipResponseTaxes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayslipResponseTaxes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayslipResponse_taxes';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['employer_tax'] === null) {
            $invalidProperties[] = "'employer_tax' can't be null";
        }
     ...
     * Sets employer_tax
     *
     * @param bool $employer_tax employer_tax
     *
     * @return self
     */
