...
class ScopesResponse
{
    ...
    const XHR_COMPANY = '/2023-03-01/xhr/company';
    const XHR_EMPLOYEE = '/2023-03-01/xhr/employee';
    const XHR_EMPLOYEES = '/2023-03-01/xhr/employees';
    const XHR_GROUPS = '/2023-03-01/xhr/groups';
    const XHR_IDENTITY = '/2023-03-01/xhr/identity';
    const XHR_PAYRUNS = '/2023-03-01/xhr/payruns';
    const XHR_PAYRUNS_PAYRUN_ID = '/2023-03-01/xhr/payruns/:payrun_id';
    const XHR_TIME_OFF_BALANCES = '/2023-03-01/xhr/time-off-balances';
    const XHR_TIME_OFF_ENTRIES = '/2023-03-01/xhr/time-off-entries';
    const XHR_TIMESHEETS = '/2023-03-01/xhr/timesheets';
    const XHR_WORK_LOCATIONS = '/2023-03-01/xhr/work-locations';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::XHR_IDENTITY,
            self::XHR_PAYRUNS,
            self::XHR_PAYRUNS_PAYRUN_ID,
            self::XHR_TIME_OFF_BALANCES,
            self::XHR_TIME_OFF_ENTRIES,
            self::XHR_TIMESHEETS,
            self::XHR_WORK_LOCATIONS,
        ];
    }
}
