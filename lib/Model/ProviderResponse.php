...
/**
 * ProviderResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ProviderResponse
{
    ...
    const CEZANNE = 'cezanne';
    const CHARLIEHR = 'charliehr';
    const DEEL = 'deel';
    const DEPUTY = 'deputy';
    const HAILYHR = 'hailyhr';
    const HIBOB = 'hibob';
    const HUMAANS = 'humaans';
    const IRIS_CASCADE = 'iris cascade';
    const MOOREPAY = 'moorepay';
    const NMBRS = 'nmbrs';
    const PAROLLA_IE = 'parolla.ie';
    const PAYFIT = 'payfit';
