...
class InlineResponse409 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets code
     *
     * @param string|null $code The authorization code insert that caused a conflict
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token The access token insert that caused a conflict
     *
     * @return self
     */
     ...
     * Sets error
     *
     * @param string $error The description of the type of error, ie conflict of two requests of the the same authorization code
     *
     * @return self
     */
