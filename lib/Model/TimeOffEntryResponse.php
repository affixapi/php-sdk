...
/**
 * TimeOffEntryResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TimeOffEntryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeOffEntryResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['remote_modified_at'] === null) {
            $invalidProperties[] = "'remote_modified_at' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id The Affix-assigned id of the time off entry
     *
     * @return self
     */
     ...
     * Sets remote_id
     *
     * @param string $remote_id the remote system-assigned id of the time off entry
     *
     * @return self
     */
     ...
     * Sets employee_id
     *
     * @param string $employee_id the Affix-assigned id of the individual
     *
     * @return self
     */
     ...
     * Sets employee_note
     *
     * @param string $employee_note employee_note
     *
     * @return self
     */
    ...
    /**
     * Gets remote_modified_at
     *
     * @return \DateTime
     */
    public function getRemoteModifiedAt()
    {
        return $this->container['remote_modified_at'];
    }

    /**
     * Sets remote_modified_at
     *
     * @param \DateTime $remote_modified_at remote_modified_at
     *
     * @return self
     */
    public function setRemoteModifiedAt($remote_modified_at)
    {
        $this->container['remote_modified_at'] = $remote_modified_at;
