...
/**
 * LocationNoNonNullRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LocationNoNonNullRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'location-no-non-nullRequest';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'type' => 'string',
        'address' => '\OpenAPI\Client\Model\AddressNoNonNullRequest'
    ];
     ...
     * Sets name
     *
     * @param string $name System assigned description of the location
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The location's type. In cases where there is no clear mapping, the original value passed through will be returned.
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\AddressNoNonNullRequest
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\AddressNoNonNullRequest $address address
     *
     * @return self
     */
