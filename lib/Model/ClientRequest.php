 ...
 */
class ClientRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['webhook_uri'] = $data['webhook_uri'] ?? null;
    }
     ...
     * Sets client_secret
     *
     * @param string[] $client_secret The client secret(s). It is an array datatype to allow for rotation of secrets without downtime for your customers
     *
     * @return self
     */
     ...
     * Sets redirect_uris
     *
     * @param string[] $redirect_uris Indicates the URI to return the user to after authorization is complete, which is the endpoint on your server to receive the authorization_code.  Must be identical to the redirect URI provided in the original link.  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name of your app that shows up in the Affix Connect application
     *
     * @return self
     */
    ...
    {
        return $this->container['webhook_uri'];
    }

    /**
     * Sets webhook_uri
     *
     * @param string|null $webhook_uri If enabled, webhooks will be sent to this endpoint
     *
     * @return self
     */
    public function setWebhookUri($webhook_uri)
    {
        $this->container['webhook_uri'] = $webhook_uri;
