...
/**
 * ScopesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ScopesResponse
{
     ...
     */
    const OFFICIAL_COMPANY = '/2023-03-01/official/company';
    const OFFICIAL_EMPLOYEE = '/2023-03-01/official/employee';
    const OFFICIAL_EMPLOYEES = '/2023-03-01/official/employees';
    const OFFICIAL_GROUPS = '/2023-03-01/official/groups';
    const OFFICIAL_IDENTITY = '/2023-03-01/official/identity';
    const OFFICIAL_TIME_OFF_BALANCES = '/2023-03-01/official/time-off-balances';
    const OFFICIAL_TIME_OFF_ENTRIES = '/2023-03-01/official/time-off-entries';
    const OFFICIAL_TIMESHEETS = '/2023-03-01/official/timesheets';
    const OFFICIAL_WORK_LOCATIONS = '/2023-03-01/official/work-locations';
    const DEVELOPER_COMPANY = '/2023-03-01/developer/company';
    const DEVELOPER_EMPLOYEE = '/2023-03-01/developer/employee';
    const DEVELOPER_EMPLOYEES = '/2023-03-01/developer/employees';
    const DEVELOPER_GROUPS = '/2023-03-01/developer/groups';
    const DEVELOPER_IDENTITY = '/2023-03-01/developer/identity';
    const DEVELOPER_PAYRUNS = '/2023-03-01/developer/payruns';
    const DEVELOPER_PAYRUNS_PAYRUN_ID = '/2023-03-01/developer/payruns/:payrun_id';
    const DEVELOPER_TIME_OFF_BALANCES = '/2023-03-01/developer/time-off-balances';
    const DEVELOPER_TIME_OFF_ENTRIES = '/2023-03-01/developer/time-off-entries';
    const DEVELOPER_TIMESHEETS = '/2023-03-01/developer/timesheets';
    const DEVELOPER_WORK_LOCATIONS = '/2023-03-01/developer/work-locations';
    ...
    {
        return [
            self::OFFICIAL_COMPANY,
            self::OFFICIAL_EMPLOYEE,
            self::OFFICIAL_EMPLOYEES,
            self::OFFICIAL_GROUPS,
            self::OFFICIAL_IDENTITY,
            self::OFFICIAL_TIME_OFF_BALANCES,
            self::OFFICIAL_TIME_OFF_ENTRIES,
            self::OFFICIAL_TIMESHEETS,
            self::OFFICIAL_WORK_LOCATIONS,
            self::DEVELOPER_COMPANY,
            self::DEVELOPER_EMPLOYEE,
            self::DEVELOPER_EMPLOYEES,
            self::DEVELOPER_GROUPS,
            self::DEVELOPER_IDENTITY,
            self::DEVELOPER_PAYRUNS,
            self::DEVELOPER_PAYRUNS_PAYRUN_ID,
            self::DEVELOPER_TIME_OFF_BALANCES,
            self::DEVELOPER_TIME_OFF_ENTRIES,
            self::DEVELOPER_TIMESHEETS,
            self::DEVELOPER_WORK_LOCATIONS,
        ];
    }
}
